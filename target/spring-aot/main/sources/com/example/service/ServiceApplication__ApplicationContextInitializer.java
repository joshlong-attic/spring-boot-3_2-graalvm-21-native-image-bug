 ...
 */
public class ServiceApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new ServiceApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new ServiceApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
