...
public class RestTemplateObservationConfiguration__BeanDefinitions {
  ...
  private static BeanInstanceSupplier<ObservationRestTemplateCustomizer> getObservationRestTemplateCustomizerInstanceSupplier(
    ...
    return BeanInstanceSupplier.<ObservationRestTemplateCustomizer>forFactoryMethod(RestTemplateObservationConfiguration.class, "observationRestTemplateCustomizer", ObservationRegistry.class, ObjectProvider.class, ObservationProperties.class, MetricsProperties.class)
